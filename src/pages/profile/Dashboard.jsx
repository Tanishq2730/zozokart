        ...
        <>
            ...
            <section className='pt-10 pb-10'>
                <div className='container'>
                    <div className='col-12 d-flex px-20 py-30' style={{ backgroundImage: 'url(assets/images/common/web-banner.jpg)', backgroundSize: 'cover', borderRadius: '10px' }}>
                        <img src='assets/images/common/profile-pic.jpg' alt='' width="100px" className='rounded' />
                        <div className='ms-10 mt-3'>
                            <h5 className='text-white text-18 mb-0'>John Deo</h5>
                            <p className='mb-0 text-white'>Info@gmail.com</p>
                            <p className='mb-0 text-white'>1234567</p>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="tab-content border p-20" id="v-pills-tabContent" >
                                ...
                                >
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className='col-md-4 mb-10'>
                                            <div className='p-20 border'>
                                                <h2 className='mb-0 me-10 text-26'><b> ₹ 500.00</b></h2>
                                                <h5 className='text-18 mt-0'>
                                                    Wallet Balance
                                                </h5>
                                            </div>
