        ...
        <div className="row gy-4 vendor-card-wrapper">
          <div className="col-xxl-3 col-lg-4 col-sm-6">
            <div className="vendor-card text-center px-16 pb-24">
              <div className="">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/vendor-logo1.png"
                  alt=""
              ...
              <div className="vendor-card__list mt-22 flex-center flex-wrap gap-8">
                <div className="vendor-card__item bg-white rounded-circle flex-center">
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/vendor-img1.png"
                    alt=""
                  />
                </div>
                <div className="vendor-card__item bg-white rounded-circle flex-center">
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/vendor-img2.png"
                    alt=""
                  />
                </div>
                <div className="vendor-card__item bg-white rounded-circle flex-center">
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/vendor-img3.png"
                    alt=""
                  />
                </div>
                <div className="vendor-card__item bg-white rounded-circle flex-center">
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/vendor-img4.png"
                    alt=""
                  />
                </div>
                <div className="vendor-card__item bg-white rounded-circle flex-center">
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/vendor-img5.png"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div className="col-xxl-3 col-lg-4 col-sm-6">
            <div className="vendor-card text-center px-16 pb-24">
              <div className="">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/vendor-logo2.png"
                  alt=""
                  className="vendor-card__logo m-12"
                />
          ...
          <div className="col-xxl-3 col-lg-4 col-sm-6">
            <div className="vendor-card text-center px-16 pb-24">
              <div className="">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/vendor-logo3.png"
                  alt=""
                  className="vendor-card__logo m-12"
                />
          ...
          <div className="col-xxl-3 col-lg-4 col-sm-6">
            <div className="vendor-card text-center px-16 pb-24">
              <div className="">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/vendor-logo4.png"
                  alt=""
                  className="vendor-card__logo m-12"
                />
          ...
          <div className="col-xxl-3 col-lg-4 col-sm-6">
            <div className="vendor-card text-center px-16 pb-24">
              <div className="">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/vendor-logo5.png"
                  alt=""
                  className="vendor-card__logo m-12"
                />
          ...
          <div className="col-xxl-3 col-lg-4 col-sm-6">
            <div className="vendor-card text-center px-16 pb-24">
              <div className="">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/vendor-logo6.png"
                  alt=""
                  className="vendor-card__logo m-12"
                />
          ...
          <div className="col-xxl-3 col-lg-4 col-sm-6">
            <div className="vendor-card text-center px-16 pb-24">
              <div className="">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/vendor-logo7.png"
                  alt=""
                  className="vendor-card__logo m-12"
                />
          ...
          <div className="col-xxl-3 col-lg-4 col-sm-6">
            <div className="vendor-card text-center px-16 pb-24">
              <div className="">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/vendor-logo8.png"
                  alt=""
                  className="vendor-card__logo m-12"
                />
