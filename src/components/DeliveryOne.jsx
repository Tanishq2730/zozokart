    ...
    <div className="delivery-section">
      <div className="container container-lg">
        <div className="delivery position-relative rounded-16 bg-main-600 p-16 flex-align gap-16 flex-wrap z-1">
          <img
            src="/zozo_cart_website/assets/images/bg/delivery-bg.png"
            alt=""
          ...
          <div className="row align-items-center">
            <div className="col-md-3 d-md-block d-none">
              <div className="delivery__man text-center">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/delivery-man.png"
                  alt=""
                />
              </div>
            </div>
            <div className="col-md-5 col-sm-7">
              <div className="text-center">
                <h4 className="text-white mb-8">
                  We Delivery on Next Days from 10:00 AM to 09:00 PM
                </h4>
                <p className="text-white">
                  For Order Benefit Get Our Subscription Plan
                </p>
                <Link
                  to="/subscription"
            ...
            <div className="col-md-4 col-sm-5 d-sm-block d-none">
              <img
                src="/zozo_cart_website/assets/images/common/milk-product.png"
                alt=""
                className="topanimation"
              />
            </div>
          </div>
        </div>
