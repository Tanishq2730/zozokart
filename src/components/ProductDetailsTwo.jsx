              ...
              <div className="col-xl-6">
                <div className="product-details__content">
                  <div className="flex-center mb-24 flex-wrap gap-16 bg-color-one rounded-8 py-16 px-24 position-relative z-1">
                    <img
                      src="/zozo_cart_website/assets/images/bg/details-offer-bg.png"
                      alt=""
                  ...
                  <div className="mt-32">
                    ...
                    <div className="mt-10">
                      <img
                        src="/zozo_cart_website/assets/images/thumbs/gateway-img.png"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div className="mt-32">
                <div className="px-16 py-8 bg-main-50 rounded-8 flex-between gap-24 mb-14">
                  ...
                  <span className="text-sm text-neutral-600">
                    Ship from <span className="fw-semibold">
                      MarketPro
                    </span>{" "}
                  </span>
                </div>
        ...
        <div className="pt-80">
          <div className="product-dContent border rounded-24">
            <div className="product-dContent__header border-bottom border-gray-100 flex-between flex-wrap gap-16">
              ...
              >
                <img
                  src="/zozo_cart_website/assets/images/icon/satisfaction-icon.png"
                  alt=""
                />
