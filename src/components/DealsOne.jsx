      ...
      <div className="container container-lg">
        <div className="border border-gray-100 p-24 rounded-16">
          ...
          <div className="deal-week-box rounded-16 overflow-hidden flex-between position-relative z-1 mb-24">
            <img
              src="/zozo_cart_website/assets/images/bg/week-deal-bg.png"
              alt=""
            ...
            <div className="d-lg-block d-none ps-32 flex-shrink-0">
              <img
                src="/zozo_cart_website/assets/images/thumbs/week-deal-img1.png"
                alt=""
              />
            </div>
            ...
            <div className="d-lg-block d-none flex-shrink-0 pe-xl-5">
              <div className="me-xxl-5">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/week-deal-img2.png"
                  alt=""
                />
              </div>
            </div>
              ...
              <div>
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    ...
                    <img
                      src="/zozo_cart_website/assets/images/thumbs/product-two-img1.png"
                      alt=""
              ...
              <div>
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    ...
                    <img
                      src="/zozo_cart_website/assets/images/thumbs/product-two-img2.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
              ...
              <div>
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    ...
                    <img
                      src="/zozo_cart_website/assets/images/thumbs/product-two-img3.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
              ...
              <div>
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    ...
                    <img
                      src="/zozo_cart_website/assets/images/thumbs/product-two-img4.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
              ...
              <div>
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    ...
                    <img
                      src="/zozo_cart_website/assets/images/thumbs/product-two-img5.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
              ...
              <div>
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    ...
                    <img
                      src="/zozo_cart_website/assets/images/thumbs/product-two-img6.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
              ...
              <div>
                <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                  ...
                  >
                    ...
                    <img
                      src="/zozo_cart_website/assets/images/thumbs/product-two-img9.png"
                      alt=""
                      className="w-auto max-w-unset"
                    />
                  </Link>
