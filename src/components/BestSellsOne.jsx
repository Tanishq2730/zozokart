        ...
        <div className="row g-12">
              ...
              <div className="col-md-6">
                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                  <div className="">
                    ...
                    >
                      <img
                        src="/zozo_cart_website/assets/images/thumbs/best-sell1.png"
                        alt=""
                      />
                    </Link>
              ...
              <div className="col-md-6">
                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                  <div className="">
                    ...
                    >
                      <img
                        src="/zozo_cart_website/assets/images/thumbs/best-sell2.png"
                        alt=""
                      />
                    </Link>
              ...
              <div className="col-md-6">
                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                  <div className="">
                    ...
                    >
                      <img
                        src="/zozo_cart_website/assets/images/thumbs/best-sell3.png"
                        alt=""
                      />
                    </Link>
              ...
              <div className="col-md-6">
                <div className="product-card style-two h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 flex-align gap-16">
                  <div className="">
                    ...
                    >
                      <img
                        src="/zozo_cart_website/assets/images/thumbs/best-sell4.png"
                        alt=""
                      />
                    </Link>
          ...
          <div className="col-xxl-4">
            <div className="position-relative rounded-16 bg-light-purple overflow-hidden p-28 z-1 text-center">
              <div className="">
                <img
                  src="/zozo_cart_website/assets/images/bg/special-snacks.png"
                  alt=""
                ...
                <div className="d-xxl-block d-none">
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/special-snacks-img.png"
                    alt=""
                  />
                </div>
              </div>
