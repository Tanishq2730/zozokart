        ...
        <div className="row gy-4 g-12">
          <div className="col-xxl-2 col-lg-3 col-sm-4 col-6">
            <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
              ...
              >
                <img
                  src="/zozo_cart_website/assets/images/thumbs/product-img1.png"
                  alt=""
                />
              </Link>
              <div className="product-card__content mt-12">
                <div className="product-card__price mb-16">
                  ...
                  <span className="text-heading text-md fw-semibold ">
                    $14.99 <span className="text-gray-500 fw-normal">
                      /MRP
                    </span>{" "}
                  </span>
                </div>
          ...
          <div className="col-xxl-2 col-lg-3 col-sm-4 col-6">
            <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
              ...
              >
                <img
                  src="/zozo_cart_website/assets/images/thumbs/product-img2.png"
                  alt=""
                />
              </Link>
              <div className="product-card__content mt-12">
          ...
          <div className="col-xxl-2 col-lg-3 col-sm-4 col-6">
            <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
              ...
              >
                <img
                  src="/zozo_cart_website/assets/images/thumbs/product-img3.png"
                  alt=""
                />
              </Link>
              <div className="product-card__content mt-12">
          ...
          <div className="col-xxl-2 col-lg-3 col-sm-4 col-6">
            <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
              ...
              >
                <img
                  src="/zozo_cart_website/assets/images/thumbs/product-img5.png"
                  alt=""
                />
              </Link>
              <div className="product-card__content mt-12">
          ...
          <div className="col-xxl-2 col-lg-3 col-sm-4 col-6">
            <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
              ...
              >
                <img
                  src="/zozo_cart_website/assets/images/thumbs/product-img6.png"
                  alt=""
                />
              </Link>
              <div className="product-card__content mt-12">
