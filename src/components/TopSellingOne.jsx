          ...
          <div className="row g-12">
            <div className="col-md-4">
              <div className="position-relative rounded-16 overflow-hidden p-28 z-1 text-center">
                <img
                  src="/zozo_cart_website/assets/images/bg/deal-bg.png"
                  alt=""
                ...
                <div className="d-md-block d-none mt-36">
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/deal-img.png"
                    alt=""
                  />
                </div>
              </div>
                  ...
                  <div>
                    <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                      ...
                      >
                        ...
                        <img
                          src="/zozo_cart_website/assets/images/thumbs/product-two-img7.png"
                          alt=""
                  ...
                  <div>
                    <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                      ...
                      >
                        ...
                        <img
                          src="/zozo_cart_website/assets/images/thumbs/product-two-img8.png"
                          alt=""
                          className="w-auto max-w-unset"
                        />
                      </Link>
                  ...
                  <div>
                    <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                      ...
                      >
                        ...
                        <img
                          src="/zozo_cart_website/assets/images/thumbs/product-two-img10.png"
                          alt=""
                          className="w-auto max-w-unset"
                        />
                      </Link>
