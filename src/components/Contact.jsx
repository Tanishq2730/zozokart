                ...
                <div className="row gy-5">
                    <div className="col-lg-8">
                        <div className="contact-box border border-gray-100 rounded-16 px-24 py-40">
                            <form action="#">
                                <h6 className="mb-32">Contact Us For Any Questions</h6>
                        ...
                        <div className="contact-box border border-gray-100 rounded-16 px-24 py-40">
                            ...
                            <div className="flex-align gap-16 mb-0">
                                ...
                                <span className="text-md text-gray-900 ">
                                    Shop No 2, Avishkar Regency, Next to Mankar Dosa, Opp to CRU Mall, Gangadham, Marketyard - Pune 411037
                                </span>
                            </div>
                        </div>
