        ...
        <div className="row g-12">
          <div className="col-md-4">
            <div className="hot-deals position-relative rounded-16 bg-main-600 overflow-hidden p-28 z-1 text-center">
              <img
                src="/zozo_cart_website/assets/images/shape/offer-shape.png"
                alt=""
              ...
              <div className="hot-deals__thumb">
                <img
                  src="/zozo_cart_website/assets/images/thumbs/hot-deals-img.png"
                  alt=""
                />
              </div>
              ...
              <Slider {...settings}>
                <div>
                  <div className="product-card h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                    ...
                    >
                      <img
                        src="/zozo_cart_website/assets/images/thumbs/product-img8.png"
                        alt=""
                      />
                    </Link>
                ...
                <div>
                  <div className="product-card h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                    ...
                    >
                      <img
                        src="/zozo_cart_website/assets/images/thumbs/product-img9.png"
                        alt=""
                      />
                    </Link>
                    <div className="product-card__content p-sm-2">
                ...
                <div>
                  <div className="product-card h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                    ...
                    >
                      <img
                        src="/zozo_cart_website/assets/images/thumbs/product-img10.png"
                        alt=""
                      />
                    </Link>
                    <div className="product-card__content p-sm-2">
                ...
                <div>
                  <div className="product-card h-100 p-8 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                    ...
                    >
                      <img
                        src="/zozo_cart_website/assets/images/thumbs/product-img18.png"
                        alt=""
                      />
                    </Link>
                    <div className="product-card__content p-sm-2">
