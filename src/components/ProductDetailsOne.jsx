        ...
        <section className="product-details py-0 mt-30">
            <div className="container-fluid">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-10">
                                        <div className="product-details__left">
                                            <div className="product-details__thumb-slider border border-gray-100 p-5 rounded-16" style={{display:'block!important',position:'relative'}}>
                                                {/* Main Image Slider */}
                                                <span style={{zIndex:'9999999'}} className='product-card__badge bg-danger-600 px-8 py-4 text-sm text-white position-absolute inset-inline-start-0 inset-block-start-0'>
                                                     50% OFF
                                                </span>
                                                    ...
                                                    {productImages.map((image, index) => (
                                                        ...
                                                        >
                                                            <img
                                                                ...
                                                                style={{ width: "400px", margin:'0 auto',cursor:'pointer' }}
                                            ...
                                            <div className='row'>
                                                {packs.map((pack) => (
                                                    <div style={{ position: 'relative' }} className={`col-md-3 rounded pack-button ${selectedPack?.size === pack.size ? "selected" : ""}`} key={pack.size} onClick={() => handlePackSelection(pack)}>
                                                        <span className='bg-main-two-700 text-white px-1' 
                                                            style={{ 
                                                                position: 'absolute', 
                                                                top: '-8px', 
                                                                right: '10px', 
                ...
                <div className='ads-banner mt-30'>
                    <img src='assets/images/common/ads-banner.jpg' className='rounded' alt=''   />
                </div>
            </div>
        </section >
