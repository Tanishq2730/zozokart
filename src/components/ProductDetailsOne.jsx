											...
											<ul>
												{productImages.map((image, index) => (
													<li
														...
														className={`mb-10 center max-w-120 max-h-120 h-100 flex-center border rounded-16 p-8 ${photoIndex === index
																? "border-primary"
																: "border-gray-100"
															}`}
														key={index}
							...
							<div className="col-xl-4">
								<div className="product-details__content">
									...
									<div className="productdetaillist">
										...
										{parsedSpecifications.map((specs, index) => (
											<>
												<span className="text-gray-900 mb-0" key={index}>{specs.heading}</span>
												<ul className="list-inside ms-12 mb-10">
