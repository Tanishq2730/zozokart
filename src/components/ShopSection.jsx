            ...
            <div className="container container-lg">
                <div className="row">
                    ...
                    <div className='col-md-12'>
                        <div className="row">
                            <div className="col-4">
                                <img src='assets/images/common/petail-grid-1.jpg' className='rounded' alt="" width="100%" />
                            </div>
                            <div className="col-4">
                                <img src='assets/images/common/productdetail-grid3.jpg' className='rounded' alt="" width="100%" />
                            </div>
                            <div className="col-4">
                                <img src='assets/images/common/produt-grid-2.jpg' className='rounded' alt="" width="100%" />
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-12 ">
                        ...
                        <div className={`list-grid-wrapper ${grid && "list-view"}`}>
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/common/ghee-2.png"
                                        alt=""
                                        className="w-100 max-w-unset"
                                    />
                                </Link>
                                <div className="product-card__content mt-16">
                                    ...
                                    <div className="product-card__price my-20">
                                        ...
                                        <span className="text-heading text-md fw-semibold ">
                                            ₹900.00 <span className="text-gray-500 fw-normal">/MRP</span>{" "}
                                        </span>
                                    </div>
                                    <Link
                                        to="/"
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/common/ghee-4.png"
                                        alt=""
                                        className="w-100 max-w-unset"
                                    />
                                </Link>
                                <div className="product-card__content mt-16">
                                    ...
                                    <div className="product-card__price my-20">
                                        ...
                                        <span className="text-heading text-md fw-semibold ">
                                            ₹2,400.00 <span className="text-gray-500 fw-normal">/MRP</span>{" "}
                                        </span>
                                    </div>
                                    <Link
                                        to="/"
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    ...
                                    <img
                                        src="assets/images/common/oil-1.jpg"
                                        alt=""
                                        className="w-100 max-w-unset"
                                    />
                                </Link>
                                <div className="product-card__content mt-16">
                                    ...
                                    <div className="product-card__price my-20">
                                        ...
                                        <span className="text-heading text-md fw-semibold ">
                                            ₹650.00 <span className="text-gray-500 fw-normal">/MRP</span>{" "}
                                        </span>
                                    </div>
                                    <Link
                                        to="/"
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/common/oil-2.jpg"
                                        alt=""
                                        className="w-100 max-w-unset"
                                    />
                                </Link>
                                <div className="product-card__content mt-16">
                                    ...
                                    <div className="product-card__price my-20">
                                        ...
                                        <span className="text-heading text-md fw-semibold ">
                                            ₹449.00 <span className="text-gray-500 fw-normal">/MRP</span>{" "}
                                        </span>
                                    </div>
                                    <Link
                                        to="/"
                            ...
                            <div className="product-card h-100 p-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                >
                                    <img
                                        src="assets/images/common/oil-4.jpg"
                                        alt=""
                                ...
                                <div className="product-card__content mt-16">
                                    ...
                                    <div className="product-card__price my-20">
                                        ...
                                        <span className="text-heading text-md fw-semibold ">
                                            ₹600.00 <span className="text-gray-500 fw-normal">/MRP</span>{" "}
                                        </span>
                                    </div>
                                    <Link
                                        to="/"
