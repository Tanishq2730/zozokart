        ...
        <div className="row gy-4">
          <div className="col-lg-4 col-sm-6">
            <div className="position-relative rounded-16 overflow-hidden z-1 p-32">
              <img
                src="/zozo_cart_website/assets/images/bg/promo-bg-img1.png"
                alt=""
              ...
              <div className="flex-between flex-wrap gap-16">
                ...
                <div className="pe-xxl-4">
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/promo-img1.png"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="position-relative rounded-16 overflow-hidden z-1 p-32">
              <img
                src="/zozo_cart_website/assets/images/bg/promo-bg-img2.png"
                alt=""
                className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 h-100 object-fit-cover z-n1"
              />
              <div className="flex-between flex-wrap gap-16">
                ...
                <div className="pe-xxl-4">
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/promo-img2.png"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="position-relative rounded-16 overflow-hidden z-1 p-32">
              <img
                src="/zozo_cart_website/assets/images/bg/promo-bg-img3.png"
                alt=""
                className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 h-100 object-fit-cover z-n1"
              />
              <div className="flex-between flex-wrap gap-16">
                ...
                <div className="pe-xxl-4">
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/promo-img3.png"
                    alt=""
                  />
                </div>
              </div>
