          ...
          <Slider {...settings}>
            <div>
              <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/product-img20.png"
                    alt=""
                  />
                </Link>
            ...
            <div>
              <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/product-img21.png"
                    alt=""
                  />
                </Link>
                <div className="product-card__content mt-12">
            ...
            <div>
              <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/product-img22.png"
                    alt=""
                  />
                </Link>
                <div className="product-card__content mt-12">
            ...
            <div>
              <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/product-img23.png"
                    alt=""
                  />
                </Link>
                <div className="product-card__content mt-12">
            ...
            <div>
              <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/product-img24.png"
                    alt=""
                  />
                </Link>
                <div className="product-card__content mt-12">
            ...
            <div>
              <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                ...
                >
                  <img
                    src="/zozo_cart_website/assets/images/thumbs/product-img25.png"
                    alt=""
                  />
                </Link>
                <div className="product-card__content mt-12">
